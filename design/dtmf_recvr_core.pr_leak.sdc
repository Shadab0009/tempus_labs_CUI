...
set_clock_uncertainty 0.1 -hold  -from [get_clocks {*}] -to [get_clocks {*}]
...
set_disable_timing TEST_CONTROL_INST/p214748365A98 -from B1 -to  ZN    
set_multicycle_path 20 -setup -from TDSP_CORE_INST/DECODE_INST/ir_reg[9] -to TDSP_CORE_INST/EXECUTE_INST/p_reg[31]  
