# opt_signoff -drv 
# set_db settings :
# 	 opt_signoff_eco_file_prefix "DRV"
...
eco_add_repeater -cells BUF_X4 -name FE_ESOC0_FE_OFN24_tdsp_data_out_8 -pins {  RESULTS_CONV_INST/p7148A29051/A } -relative_distance_to_sink 0 -location { 256.880000 341.600000 } -buffer_orient MX
eco_add_repeater -cells BUF_X32 -name FE_ESOC1_FE_OFN16_ds_datain_0 -pins {  FE_OFC16_ds_datain_0_/Z } -relative_distance_to_sink 1 -location { 85.690000 253.400000 } -buffer_orient R0
eco_add_repeater -cells BUF_X32 -name FE_ESOC2_FE_OFN52_ds_datain_1 -pins {  FE_OFC52_ds_datain_1_/Z } -relative_distance_to_sink 1 -location { 79.610000 254.800000 } -buffer_orient MX
eco_add_repeater -cells BUF_X8 -name FE_ESOC3_n_623 -pins {  TDSP_CORE_INST/EXECUTE_INST/p8543A/ZN } -relative_distance_to_sink 1 -location { 224.390000 240.800000 } -buffer_orient MX
eco_add_repeater -cells BUF_X32 -name FE_ESOC4_ds_datain_12 -pins {  DATA_SAMPLE_MUX_INST/Fp9562A492/ZN } -relative_distance_to_sink 1 -location { 258.780000 267.400000 } -buffer_orient R0
report_resource
