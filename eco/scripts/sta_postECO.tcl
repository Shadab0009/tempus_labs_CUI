...
report_timing -late -max_paths 1000 -max_slack 0.1 -output_format gtd > design_before_late.mtarpt.gz
report_timing -early -max_paths 1000 -max_slack 0.1 -output_format gtd  > design_before_early.mtarpt.gz
